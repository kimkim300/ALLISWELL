...
class MemoApp {
    ...
    bindEvents() {
        ...
        if (monthlyGoalBtn) {
            monthlyGoalBtn.addEventListener('click', () => this.showMonthlyGoalModal());
        }
        if (closeGoalModal) {
            closeGoalModal.addEventListener('click', () => this.hideMonthlyGoalModal());
        }
        if (saveMonthlyGoal) {
            saveMonthlyGoal.addEventListener('click', () => this.saveMonthlyGoal());
        }
        if (clearMonthlyGoal) {
            clearMonthlyGoal.addEventListener('click', () => this.clearMonthlyGoal());
        }
    ...
    loadMonthlyGoal() {
        ...
        if (savedGoal) {
            ...
            document.getElementById('currentGoalText').textContent = goalData.text;
            document.getElementById('goalDate').textContent = goalData.date;
        } else {
    ...
    editMonthlyGoal() {
        ...
        // Firebase에 업데이트
        this.updateMonthlyGoalInFirebase(goalData);
